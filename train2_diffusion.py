...
from processing.dataset_diffusion import MelSpectrogramDataset, collate_fn, create_dataloaders
...
def main():
    ...
    callbacks = setup_callbacks("checkpoints", base_name, val_loader)
...
def setup_callbacks(checkpoint_folder, base_name, val_loader):
    ...
    return [checkpoint_callback, latest_checkpoint_callback]
